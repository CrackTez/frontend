        ...
        <>
            ...
            <div className='flex flex-col mt-6'>
                <textarea
                    name='title'
                    id='blogTitle'
                    className='resize-none w-full rounded-md p-2 text-2xl font-bold active-outline'
                    rows='1'
                    placeholder='Title...'
                    value={titleText}
            ...
            <div className={`text-area ${currentTab != 0 && "hidden"}`}>
                <textarea
                    className='resize-none w-full border border-gray-300 p-2 rounded-b-lg text-lg min-h-24 no-ring focus:border-gray-300 active-outline'
                    rows='10'
